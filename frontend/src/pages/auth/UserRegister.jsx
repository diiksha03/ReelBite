...
const UserRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (error.response) {
                alert(`Registration Failed: ${error.response.data.message || 'Invalid form data'}`);
            } else {
                alert("Registration Failed: Unable to reach the server. Please check your backend.");
            }
        }
    };
